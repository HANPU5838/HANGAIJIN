...
class JsBridge(
    ...
    fun saveToolSelections(json: String) {
        val configFile = java.io.File(bootstrapManager.homeDir, ".HAN/tool-selections.conf")
    ...
    fun switchPlatform(id: String) {
        ...
        val markerFile = java.io.File(bootstrapManager.homeDir, ".HAN/.platform")
    ...
    fun getInstalledTools(): String {
        ...
        val nodeBin = "${bootstrapManager.homeDir.absolutePath}/.HAN/node/bin"
        val npmBinChecks =
            mapOf(
